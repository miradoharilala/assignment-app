...
export class AssignmentsService {
  ...
  getAssignment(id:number):Observable<Assignment> {
    ...
    .pipe(
      // traitement 1
      map(a => {
        a.matiere.nom += " MODIFIE PAR MAP";
        return a;
      }),
      tap(a => {
        console.log("TRACE DANS TAP : j'ai reçu " + a.matiere.nom);
      }),
      /*
      filter(a => {
        return (a.rendu)
  ...
  updateAssignment(assignment:Assignment):Observable<any> {
    ...
    this.loggingService.log(assignment.matiere.nom, " a été modifié");
  ...
  deleteAssignment(assignment:Assignment):Observable<any> {
    ...
    */
    ...
    this.loggingService.log(assignment.matiere.nom, " a été supprimé");
